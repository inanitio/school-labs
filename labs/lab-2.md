...
Код Хемминга - код, позволяющий автоматически обнаруживать и исправлять ошибки при передаче двоичного сообщения. Если при передаче сообщения в нём поменялся какой-то бит, то алгоритм исправит ошибку и вернёт сообщение в исходном виде. При измении двух битов код сможет определить лишь количество совершённых ошибок, но не их местоположение. Большее количество ошибок не гарантирует правильность работы алгоритма в принципе.
...
В нашем случае бит чётности равен 1, и есть хотя бы один контрольный бит, равный 1. Это значит, что в нашем сообщении есть одна ошибка. И действительно, адрес ошибки - шестой бит. Исправляем ошибку, инвертировав ошибочный бит. После чего, убирая контрольные биты и инвертируя ошибочный бит, получаем наше сообщение 101001010010

## Задача
**1 часть**  
Требуется реализовать три функции `encode`, `transmission`, `decode` для бинарного сообщения. Реализовать алгоритм для каждой из частей.

**2 часть**  
Перевести сообщение в двоичный код самостоятельно по любому алгоритму, который вам нравится. После передачи расшифровать.
